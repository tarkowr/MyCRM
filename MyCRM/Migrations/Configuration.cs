namespace MyCRM.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<MyCRM.DAL.DataContext>
    {
        ...
        protected override void Seed(MyCRM.DAL.DataContext context)
        {
            ...
            memberships.ForEach(m => context.Memberships.AddOrUpdate(m));
            SaveChanges(context);
        }
